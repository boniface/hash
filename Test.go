...
func mainTEST() {
	...
	//	getArticle()
	//	getGetLinks()
	title := " on for all Former Former Opposition parties for reject ECZ ‘fake’ electronic transmission of election on results’"
...
func filterContentTest(input string) string {
